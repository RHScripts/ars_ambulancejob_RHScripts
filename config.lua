...
Config.ClothingScript          = 'illenium-appearance' -- 'illenium-appearance', 'fivem-appearance' ,'core' o false para desactivar
Config.EmsJobs                 = { "ambulance", "ems" }
Config.RespawnTime             = 0                     -- en minutos
Config.UseInterDistressSystem  = true
Config.WaitTimeForNewCall      = 5                     -- minutos
...
Config.BaseInjuryReward        = 150 -- cambia si el valor de la lesión es mayor a 1
Config.ReviveReward            = 700

Config.ParamedicTreatmentPrice = 4000
Config.AllowAlways             = true        -- false si quieres que solo funcione cuando haya médicos en línea

Config.AmbulanceStretchers     = 2           -- cuántas camillas debe tener una ambulancia
Config.ConsumeItemPerUse       = 10          -- cada vez que usas un ítem, se consume un 10%

Config.TimeToWaitForCommand    = 2           -- cuando el jugador muere, necesita esperar 2 minutos para usar el comando de ambulancia
Config.NpcReviveCommand        = "ambulance" -- esto solo funcionará cuando no haya médicos en línea

Config.UsePedToDepositVehicle  = false       -- si es false, el vehículo se desparecerá instantáneamente
Config.ExtraEffects            = true        -- false deshabilita el movimiento de pantalla y la pantalla en blanco y negro

Config.EmsVehicles             = {           -- vehículos que tienen acceso a los accesorios (conos, etc.)
	...
	["phillbox"] = {
		...
		stash = {
			['ems_stash_1'] = {
				...
				min_grade = 0,
				label = 'Ems stash',
				shared = true, -- false si quieres que cada uno tenga un alijo personal
		...
		pharmacy = {
			["ems_shop_1"] = {
				job = true,
				label = "Pharmacy",
				grade = 0, -- funciona solo si job es true
...
function Config.SendDistressCall(msg)
	...
	function SendDistressSignal()
	  ...
	  ESX.ShowNotification("Mensaje de servicio enviado")
	end
